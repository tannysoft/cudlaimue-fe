...
export function UserMenu({
  ...
  return (
    <Menu as="div" className="relative">
      <MenuButton className="group inline-flex items-center justify-center sm:justify-start sm:gap-2 rounded-full w-10 h-10 sm:w-auto sm:h-10 shrink-0 overflow-hidden sm:overflow-visible transition sm:bg-white sm:border sm:border-peach-200 sm:pl-1 sm:pr-3 sm:hover:border-peach-400 sm:hover:bg-peach-50/60">
